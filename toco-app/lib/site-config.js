...
module.exports = {
  ...
  // トップの「ピックアップ記事」の先頭に並べる記事（ここに書いた順）。
  // ここに無いピックアップ記事は、そのあとに新しい順で続きます。
  // 記事画面で「ピックアップに載せる」にしていない記事は、ここに書いても出ません。
  pickupFirst: ['rabbit-cage', 'rabbit-house', 'rabbit-playpen', 'rabbit-toilet'],
