...
うさぎと暮らして{{years}}年になりますが、準備でいちばん迷ったのは【　〜　】
...
7台を並べて比べた選び方は、{{link:rabbit-cage|ケージのおすすめ記事}}にまとめています。
...
刈り取りごとの違いと、食べてくれないときの手は{{link:rabbit-timothy|チモシーのおすすめ記事}}で詳しく書いています。

### 牧草入れ

こぼれにくさと、食べやすい高さで選びます。かじっても安全な素材かどうかも見ておきたいところ。

柵の向きによって付けられる形が変わります。散らかり対策とあわせて、{{link:rabbit-hayrack-hay|チモシー入れのおすすめ記事}}にまとめました。
...
**ボトルと皿のどちらでも構いませんが、最初はボトルが扱いやすいです。**

皿は飲みやすいかわりに、ひっくり返されたり牧草が浮いたりします。ボトルは水の減りが目で見えるので、飲んだ量に気づきやすいのも利点。ケージの柵の間隔に合う留め具かどうかは、買う前に確かめておきましょう。

違いと選び方は{{link:rabbit-bottle|給水ボトルのおすすめ記事}}で詳しく紹介しています。

### トイレ

三角形と長方形があります。体格に合うサイズを選び、ケージに固定できるかも確認しましょう。うさぎはトイレをひっくり返します。

形ごとの向き不向きと、動かされないための留め方は{{link:rabbit-toilet|トイレのおすすめ記事}}にまとめています。
...
通院と、災害のときの備えについては{{link:rabbit-carry|キャリーバッグのおすすめ記事}}で詳しく書いています。
